    ...
    <>
      ...
      <div className="hero p-5 md:p-20">
        <div className="hero-content flex-col">
          ...
          <div className="card w-full max-w-sm shrink-0 border border-blue-200 bg-base-100 shadow-2xl shadow-blue-100">
            ...
            <div className="mb-4 flex w-full flex-row justify-center">
              <button
                ...
                className="btn btn-outline text-blue-500 hover:border-blue-500 hover:bg-blue-500"
              >
                <FaGoogle />
                Google
              </button>
