    ...
    <>
      ...
      <div className="hero px-5 pb-2 pt-6 md:px-20">
        <div className="hero-content flex-col">
          ...
          <div className="card w-full max-w-sm shrink-0 bg-base-100 shadow-2xl shadow-blue-100 border border-blue-200">
            <form onSubmit={handleRegister} className="card-body pb-2">
              ...
              <div className="form-control">
                ...
                <div className="relative">
                  ...
                  />
                  <button
                    className="absolute right-2 top-4 ml-2 text-blue-500"
                    onClick={(e) => {
                      e.preventDefault();
