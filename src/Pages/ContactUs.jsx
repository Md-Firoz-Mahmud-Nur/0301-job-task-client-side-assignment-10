  ...
  return (
    <div className="bg-gray-100 p-6 lg:p-12">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">Our Information</h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mt-6 mb-4">Business Hours</h2>
          <p className="text-lg text-gray-600 mb-2">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mt-6 mb-4">Get in Touch</h2>
          <p className="text-lg text-gray-600 mb-4">
