  ...
  return (
    ...
    >
      ...
      <div className="text-2xl font-bold md:text-4xl">
        ...
        <br />
        <Link
          className="btn btn-outline mb-20 border-2 border-blue-500 bg-transparent text-xl text-blue-500 hover:border-blue-500 hover:bg-blue-500 hover:text-white"
          to="/"
        >
          Home
        </Link>
